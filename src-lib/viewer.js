      ...
      frame.addEventListener(
        ...
        () => {
          ...
          try {
            ...
            // Some PDF viewers don't support afterprint.
          }
          ...
          window.setTimeout(() => {
            ...
            // Safari sometimes renders the iframe PDF slowly and may never fire
            // afterprint; keep the URL alive long enough, then clean up.
            window.setTimeout(() => {
