...
| print preview blocked (`ERR_BLOCKED_BY_CLIENT`) | browser shields/extensions block blob preview | use **Download → PDF** and print that file                        |
| Safari opens blank print preview                | browser PDF preview race/compat issue         | download PDF and print from the file directly                     |
